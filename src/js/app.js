...
function pesquisar() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // **INÍCIO: Código para fechar a nav-list ao clicar nos links**
    const navList = document.querySelector('.nav-list');
    const mobileMenu = document.querySelector('.botao-menu'); // Usando .botao-menu em vez de .mobile-menu
    const navLinks = document.querySelectorAll('.nav-list li a');
  
    // Função para fechar a nav-list (reutilizada)
    ...
    // Adiciona um ouvinte de evento de clique a cada link na nav-list
    navLinks.forEach(link => {
      link.addEventListener('click', function(event) {
        closeNavList(); // Chama a função para fechar a nav-list
      });
    });
  
    // (Opcional) Adiciona um ouvinte de evento ao background para fechar a nav-list ao clicar fora dela
    background.addEventListener('click', function() {
      closeNavList();
    });
    // **FIM: Código para fechar a nav-list ao clicar nos links**
